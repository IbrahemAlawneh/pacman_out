...
class MainScreen:
    ...
    def __init__(
        ...
        if not self.assets_path.exists():
            print(
                f"[Warning] Directory '{self.assets_path}' "
        ...
        self.buttons = [
            {
                ...
                "rect": pygame.Rect(
                    0, self.BUTTON_START_Y, self.BUTTON_WIDTH,
                    self.BUTTON_HEIGHT
                )
            },
            {
                ...
                "rect": pygame.Rect(
                    0, self.BUTTON_START_Y + 1 * (
                        self.BUTTON_HEIGHT + self.BUTTON_GAP
    ...
    def _draw_buttons(self) -> None:
        ...
        for index, button in enumerate(self.buttons):
            ...
            button_color = (
                self.BUTTON_HOVER_COLOR if is_hovered
                or is_selected else self.BUTTON_COLOR
            )
            border_color = (
                self.BUTTON_HOVER_BORDER_COLOR
                if is_hovered or is_selected
                else self.BUTTON_BORDER_COLOR
            )
            points = [
