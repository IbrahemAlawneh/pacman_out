    ...
    def __init__(self, screen: pygame.Surface):
        ...
        for color in self.ghost_colors:
            ...
            for direction in self.directions:
                ...
                self.raw_images[color][direction.upper()] = self._load_image(filename)
    ...
    def _scale_images(self, cell_size: int) -> None:
        ...
        for color in self.ghost_colors:
            ...
            for direction, img in self.raw_images[color].items():
                self.scaled_images[color][direction] = pygame.transform.scale(img, (size, size))
                
        self.scaled_scared = pygame.transform.scale(self.raw_scared, (size, size))
